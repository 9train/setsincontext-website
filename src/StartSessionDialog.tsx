...
const sessionMode: SessionMode = "remote";

function StartSessionDialog({ onClose }: { onClose: () => void }) {
  const [step, setStep] = useState<WizardStep>("privacy");
  ...
  const remoteRuntimePending = !runtimeTarget.isReady;
  ...
  return (
    <div className="start-session-wizard">
      ...
      <footer className="wizard-footer">
        {step === "privacy" ? <span className="wizard-footer-spacer" aria-hidden="true" /> : null}
        {step === "ready" ? (
